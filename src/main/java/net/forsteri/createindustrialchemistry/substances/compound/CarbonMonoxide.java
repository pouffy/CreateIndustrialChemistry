...
public abstract class CarbonMonoxide extends RisingGases {
    protected CarbonMonoxide(Properties properties) {
        super(properties);
    }

    public Item getTank(){
        return GasSubstances.CARBON_MONOXIDE_TANK.get();
    }

    public static class Flowing extends CarbonMonoxide
    {
    ...
    public static class Source extends CarbonMonoxide
    {
